...
import se.kth.chord.msg.net.NetMsg;
import se.kth.chord.msg.net.NetNatPing;
import se.kth.chord.msg.net.NetNatPong;
import se.kth.chord.msg.parentport.NewParentAlert;
import se.kth.chord.msg.parentport.ParentPort;
import se.kth.chord.simulation.SwimScenario;
import se.kth.chord.timeout.HeartbeatTimeout;
import se.kth.chord.timeout.NatPingTimeout;
...
public class NatTraversalComp extends ComponentDefinition {
    ...
    private void sendNewParents(Set<NatedAddress> inputPeers) {
        ...
        if (listUpdated) {                                              //Send the parents to NodeComp if we have new parents
