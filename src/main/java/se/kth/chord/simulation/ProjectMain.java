 ...
 */
package se.kth.chord.simulation;
...
public class ProjectMain {
    ...
    public static void main(String[] args) {
        ...
        //Tests with for startup with different number of nodes. Message size is set in NodeComp.java
        ...
        //Test for killing 10 nodes out of 50 (20%, message size is set in NodeComp.java)
